...
export class CreateQuestionsService {
  ...
  arraySchemeTherapy = [
    ...
    {
      question: `Назвать схемы сферы ориентации на других? Первичны ли эти схемы?`,
      answer: `
      подчинение, самопожертвование, поиск признания/одобрения.
      Вторичны, первичны здесь схемы из сферы утраты связи/брошенности (потребность надежной, безопасной привязанности)
      `
    },
    {
      question: `Девиз схемы "Подчинение"?`,
      answer: `Я вынужден действовать`
    },
    {
      question: `Суть схемы "Подчинение"?`,
      answer: `
      вынужден действовать так, как хотят другие;
      если будут делать так, как хочется произойдет что-то плохое;
      адаптация и подчинение мыслям других
      `
    },
    {
      question: `Назвать пути развития схемы "Подчинение"?`,
      answer: `
      семейное моделирование: кто-то из семьи подчинялся не противодействовал другому;
      заявление о своих чувствах, потребностях жестоко каралось
      `
    },
    {
      question: `Схема "Подчинение" и копинг-стратегии?`,
      answer: `
      Капитуляция: не говорят о своих желаниях,
      выбирают доминирующих партнеров;
      Избегание: избегает отношений, ситуаций, где его желания отличаются от желаний других;
      Гиперкомпенсация: прокрастинирует, вспышки гнева, ведет себя пассивно-агрессивно
      `
    },
    {
      question: `Девиз схемы "Самопожертвование"?`,
      answer: `Ваши нужды важнее моих`
    },
    {
      question: `В чем суть схемы "Самопожертвование"?`,
      answer: `
      потребности других - превыше всего, винят себя, если заботятся о себе;
      максимально быстро расспознать потребности других и удовлетворить их
      `
    },
    {
      question: `Схемы "Самопожертвование" и копинг-стратегии?`,
      answer: `
      Капитуляция: делают много для других;
      Избегание: избегает близких отношений;
      Гиперкомпенсация: злится на неблагодарность, решает ничего не делать
      `
    },
    {
      question: `Девиз схемы "Поиск признания/одобрения"?`,
      answer: `Я отношусь к себе так, как вы относитесь ко мне`
    },
    {
      question: `В чем суть схемы "Поиск признания/одобрения"?`,
      answer: `
      ориентация на мнение других людей, самооценка напрямую зависит
      от оценки других людей, не знают своих желаний/потребностей
      `
    },
    {
      question: `Схема "Поиск признания/одобрения" и копинг-стратегии?`,
      answer: `
      Капитуляция: признание от других превыше всего;
      Избегание: избегает тех, кого уважает из-за страха не получить признание;
      Гиперкомпенсация: скандалит, привлекает внимание
      `
    },
  ];
